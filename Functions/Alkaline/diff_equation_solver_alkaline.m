function [t, theta] = diff_equation_solver_alkaline(time_array,data_type, curve, a_OH, Temperature, k_4_0_plus, theta_0)
...
[t,theta] = ode15s(@(t,theta)...                                            % using ode15s to solve the diff equation described in diff_equation(...)
    ...
    a_OH, Temperature, k_4_0_plus), t_span, theta_0);                   % This would then solve the differential equation based on a value for k_4_0_plus and gamma_theta_0
