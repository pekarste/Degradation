function [curve] = chi_square_alkaline(time_solver, theta_solver, a_OH, k_4_0_plus, time_data, degradation_data)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here

gamma = 8.16*10^(-6);                                                       % [mol/m^^2]

fun = @(k_3_0_plus, x) gamma.*k_3_0_plus.*a_OH.^(2).*interp1(time_solver,theta_solver, x);
