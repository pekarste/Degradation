function [curve, gof] = r_reksten_fit(separate_curve, E_data,i_data, a_OH, T, data_type)
...
if data_type == "Linear"
    ...
    % Anonymous function
    fun = @(gamma, k_2_0, k_1_0_plus, k_4_0_plus, x) n.*F*gamma.*a_OH.*(1 - B_reksten_no_curve(k_1_0, k_2_0, a_OH, T, x).*( 1 + k_2(k_2_0, a_OH, T, x).*(a_H2O./a_OH) + k_1(k_1_0, a_OH, T, x).*k_2(k_2_0, a_OH, T, x).*(a_H2O./(a_OH^(2))) ))./...
        (1./k_1_plus(k_1_0_plus, alpha, a_OH, T, x) + 1./k_2_plus(k_2_0_plus, alpha, a_OH, T, x) + k_1(k_1_0, a_OH, T, x)./(k_2_plus(k_2_0_plus, alpha, a_OH, T, x).*a_OH) + gamma.*A_reksten_no_curve(k_1_0, k_2_0, k_2_0_plus, k_4_0_plus, alpha, a_OH, T, x, gamma).*( 1 + k_2(k_2_0, a_OH, T, x).*(a_H2O./a_OH) + k_1(k_1_0, a_OH, T, x).*k_2(k_2_0, a_OH, T, x).*(a_H2O./(a_OH^(2))) )  );
    % Doing the fitting
    FT = fittype(fun, 'independent',{'x'}, 'coefficients',{'gamma', 'k_2_0', 'k_1_0_plus', 'k_4_0_plus'});

    FO = fitoptions('Method','NonlinearLeastSquares',...
               'Lower',[eps, eps, eps, eps],...                             % gamma, k_2_0, k_1_0_plus, k_4_0_plus,
               'Upper',[10^(-2), 10^(10), 10^(10), 10^10],...               % gamma, k_2_0, k_1_0_plus, k_4_0_plus,
               'StartPoint',[10^(-5), 10^0, 10^03, 10^3],...                 % Starting point for the coefficients
...
elseif data_type == "Logarithmic"
    ...
    % Anonymous function
    fun = @(gamma, k_2_0, k_1_0_plus, k_4_0_plus, x) log10(n.*F*gamma.*a_OH) + log10((1 - B_reksten_no_curve(k_1_0, k_2_0, a_OH, T, x).*( 1 + k_2(k_2_0, a_OH, T, x).*(a_H2O./a_OH) + k_1(k_1_0, a_OH, T, x).*k_2(k_2_0, a_OH, T, x).*(a_H2O./(a_OH^(2))) ))) - ...
        log10((1./k_1_plus(k_1_0_plus, alpha, a_OH, T, x) + 1./k_2_plus(k_2_0_plus, alpha, a_OH, T, x) + k_1(k_1_0, a_OH, T, x)./(k_2_plus(k_2_0_plus, alpha, a_OH, T, x).*a_OH) + gamma.*A_reksten_no_curve(k_1_0, k_2_0, k_2_0_plus, k_4_0_plus, alpha, a_OH, T, x, gamma).*( 1 + k_2(k_2_0, a_OH, T, x).*(a_H2O./a_OH) + k_1(k_1_0, a_OH, T, x).*k_2(k_2_0, a_OH, T, x).*(a_H2O./(a_OH^(2))) )  ));
    % Doing the fitting
    FT = fittype(fun, 'independent',{'x'}, 'coefficients',{'gamma', 'k_2_0', 'k_1_0_plus', 'k_4_0_plus'});
    ...
    FO = fitoptions('Method','NonlinearLeastSquares',...
               'Lower',[eps, eps, eps, eps],...                                         % gamma, k_2_0, k_1_0_plus, k_4_0_plus,
               'Upper',[10^(-2), 10^(10), 10^(10), 10^10],... % gamma, k_2_0, k_1_0_plus, k_4_0_plus,
               'StartPoint',[10^(-5), 10^1, 10^3, 10^2],...       % Starting point for the coefficients
               'TolFun', 10^(-22));                                         % Tolerance    
