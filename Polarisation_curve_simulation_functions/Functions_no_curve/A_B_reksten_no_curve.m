function [A, B] = A_B_reksten_no_curve(k_1_0, k_2_0, k_2_0_plus, k_4_0_plus, alpha, a_OH, T, E)
%A_B_reksten_no_curve will be a helping function to "current_density_reksten" by
%calculating the values for A and B from the expression from Reksten
% This one is separate from A_B_reksten since this will not take in any
% separate curve and will mainly be utilised in the fitting without a curve
