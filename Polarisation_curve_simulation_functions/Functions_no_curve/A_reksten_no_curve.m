function A = A_reksten_no_curve(k_1_0, k_2_0, k_2_0_plus, k_4_0_plus, alpha, a_OH, T, E, gamma)
%A_reksten_no_curve will be a helping function to "current_density_reksten" by
%calculating the value for A from the expression from Reksten
...
A = ((1./k_4_0_plus) - (k_4_0.*sqrt(a_O2))./k_2_plus.*a_OH)./...
    (1.*(1 + k_4_0.*(k_2.*(a_H2O./a_OH) + 1).*sqrt(a_O2)));                % The first 1 is actually gamma
